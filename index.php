...
<main class="flex flex-col items-center justify-center mt-8">
    ...
    <section
        ...
        style="
            background-image: url(assets/images/hero_curtains.jpg)
        ">
...
Lorem finds ipsum            </a>
            ...
            <p>
                ...
                <a
                    ...
                    target="_blank"
                    class="text-white/90 hover:text-white">
                    I Lorem on my Ipsum until I dolor sit amet
                </a>
            </p>
        </span>
    </section>
...
<div class="holder mx-auto w-10/12 grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
  ...
  <div class="each mb-10 m-2 shadow-lg border-gray-800 bg-gray-100 relative">
    ...
    <div class="info-box text-xs flex p-1 font-semibold text-gray-500 bg-gray-300">
      ...
      <span class="mr-1 p-1 px-2 font-bold border-l border-gray-400">reviews</span>
      </span>
    </div>
